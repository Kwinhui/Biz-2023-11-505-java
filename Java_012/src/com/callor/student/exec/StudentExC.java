...
public class StudentExC {
	public static void main(String[] args) {
		...
		System.out.println(StdIndex.학과.getIndex());
		System.out.println(StdIndex.학년.getIndex());
		System.out.println(StdIndex.전화번호.getIndex());
		System.out.println(StdIndex.주소.getIndex());
