...
public class ArraysD {
	public static void main(String[] args) {
		int SCORE_LENGTH = 10;
		int[] scoreKors = new int[SCORE_LENGTH];
		int[] scoreEng = new int[SCORE_LENGTH];
		int[] scoreMath = new int[SCORE_LENGTH];
		int[] sum = new int[SCORE_LENGTH];
		float[] Avg = new float[SCORE_LENGTH];
