package com.collor.hello.var;

import com.collor.hello.service.NumberService;
...
public class VarA {
	...
	public static void main(String[] args) {
		...
		// 결과를 return 받아서 console 에 출력
		 
		// NumberService 클래스에 있는 add() method 를 사용하려고 하는데
		// add() method 는 static 이 없다.
		// 그래서 이 method 는 NumberService.add() 처럼 사용할 수 없다
//		int result = NumberService.add(30, 40);
		
		// NumberService 의 add() method 를 사용 하려면
		// 먼저 준비를 해야한다.
		/*
