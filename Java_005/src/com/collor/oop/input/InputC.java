...
public class InputC {
	public static void main(String[] args) {
		...
		num1 = Integer.parseInt(str1);	// static method
		Float.parseFloat(str1);
		
		System.out.print("정수 2 >> ");
		String str2 = scan.nextLine();	// non-static method
