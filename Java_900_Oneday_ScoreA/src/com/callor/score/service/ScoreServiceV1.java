...
public class ScoreServiceV1 {
	...
	public ScoreServiceV1() {
		...
		// 클래스 영역에 선언된 socres 는 여전히 null 이다
		// List <ScoreDto> scores = new ArrayList<ScoreDto>();

		// 클래스 영역에 선언된 socres 를 생성하는 코드
	...
	public void makeScore() {
		...
		/*
		 * 학번을 자동으로 생성하기 1. scores 에 추가된 성적표가 있는가 확인
		 * 2. 없으면 최초의 성적 이므로 23001 로 학번을 세팅 
		 * 3. 있으면 가장 마지막 성적표의 
		 * 		학번을 조회하여 학번을 + 1 하여 새로운 학번을 생성하기
		 */
